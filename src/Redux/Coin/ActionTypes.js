...
export const FETCH_TOP_GAINER_COINS_REQUEST = "FETCH_TOP_GAINER_COINS_REQUEST";
export const FETCH_TOP_GAINER_COINS_SUCCESS = "FETCH_TOP_GAINER_COINS_SUCCESS";
export const FETCH_TOP_GAINER_COINS_FAILURE = "FETCH_TOP_GAINER_COINS_FAILURE";

export const FETCH_TOP_LOSER_COINS_REQUEST = "FETCH_TOP_LOSER_COINS_REQUEST";
export const FETCH_TOP_LOSER_COINS_SUCCESS = "FETCH_TOP_LOSER_COINS_SUCCESS";
export const FETCH_TOP_LOSER_COINS_FAILURE = "FETCH_TOP_LOSER_COINS_FAILURE";
